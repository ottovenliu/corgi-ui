  ...
  <React.StrictMode>
    <div>
      ...
      <div style={{ display: 'flex', width: '100%' }}>
        ...
        <div style={{ margin: '5px' }}>
          <CorgiButton type='Primary' content='Disabled Corgi' disabled={true} />
        </div>
      </div>
    </div>
    <hr />
    <div>
      ...
      <div style={{ display: 'flex', width: '100%' }}>
        ...
        <div style={{ margin: '5px' }}>
          <CorgiButton type='Destructive' content='Disabled Corgi' disabled={true} />
        </div>
      </div>
    </div>
    <hr />
    ...
    <div>
      ...
      <div style={{ display: 'flex', width: '100%' }}>
        ...
        <div style={{ margin: '5px' }}>
          <CorgiButton type='Warning' content='Disabled Corgi' disabled={true} />
        </div>
      </div>
    </div>
    <hr />
